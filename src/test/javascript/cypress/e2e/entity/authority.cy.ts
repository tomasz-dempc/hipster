...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '6c7daaef-eefb-4e5c-aca9-1e17f6fdd487' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('3f33d5d6-5e39-426b-93cb-2c5e421ba75f');
      cy.get(`[data-cy="name"]`).should('have.value', '3f33d5d6-5e39-426b-93cb-2c5e421ba75f');
